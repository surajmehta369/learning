...
if (isset($_SESSION['user_id'])) {
    ...
    if ($resultUser && $resultUser->num_rows === 1) {
        ...
        $res1 = $conn->query("SELECT COUNT(*) as total FROM notifications WHERE user_id = $user_id AND is_read = 0");
        $count1 = ($res1) ? $res1->fetch_assoc()['total'] : 0;

        $res2 = $conn->query("SELECT COUNT(*) as total FROM weekly_updates WHERE created_at > '$lastViewed'");
                    ...
                    <ul class="navbar-nav <?= ($current_page === 'Purchased.php') ? '' : 'me-auto' ?> mb-2 mb-rg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="coursesDropdown">
                                <li><a class="dropdown-item" href="ourcourses">
                                        <i class="fas fa-list"></i> All Courses
                                    </a></li>
                                <li><a class="dropdown-item" href="ourcourses?category=Web%20Development">
                                        <i class="fas fa-code"></i> Web Development
                                    </a></li>
                                <li><a class="dropdown-item" href="ourcourses?category=Frameworks">
                                        <i class="fas fa-cubes"></i> Frameworks
                                    </a></li>
                                <li><a class="dropdown-item" href="ourcourses?category=Apis">
                                        <i class="fas fa-plug"></i> APIs
                                    </a></li>
                                <li><a class="dropdown-item" href="ourcourses?category=Python">
                                ...
                                <li><a class="dropdown-item" href="coming_soon?course=Web%20Designing">
                                        <i class="fas fa-palette"></i> Web Designing
                                    </a></li>
                                <li><a class="dropdown-item" href="coming_soon?course=AI%20%26%20Machine%20Learning">
                                        <i class="fas fa-robot"></i> AI & Machine Learning
                                    </a></li>
                                <li><a class="dropdown-item" href="coming_soon?course=Cloud%20Computing">
                                        <i class="fas fa-cloud"></i> Cloud Computing
                                    </a></li>
                                <li><a class="dropdown-item" href="coming_soon?course=Cyber%20Security">
                            ...
                            <div class="dropdown me-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-3" style="width: 320px; max-height: 400px; overflow-y: auto; border-radius: 12px;">
                                    ...
                                    <div id="notificationList">
                                        ...
                                        $sql = "(SELECT message as title, message as full_msg, created_at, is_read, 'general' as type FROM notifications WHERE user_id = $user_id)
                        UNION
                        (SELECT title, message as full_msg, created_at, 0 as is_read, 'weekly' as type FROM weekly_updates)
